...
public class Lua_UITweener : LuaObject {
	...
	static public int Begin_s(IntPtr l) {
		try {
			...
			var ret=UITweener.Begin<UITweener>(a1,a2,a3);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_useFixedUpdate(IntPtr l) {
		try {
			UITweener self=(UITweener)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.useFixedUpdate);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_useFixedUpdate(IntPtr l) {
		try {
			UITweener self=(UITweener)checkSelf(l);
			System.Boolean v;
			checkType(l,2,out v);
			self.useFixedUpdate=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"useFixedUpdate",get_useFixedUpdate,set_useFixedUpdate,true);
