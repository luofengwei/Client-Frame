...
public class Lua_System_String : LuaObject {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int ToHashInt(IntPtr l) {
		try {
			System.String self=(System.String)checkSelf(l);
			System.Text.Encoding a2;
			checkType(l,2,out a2);
			var ret=self.ToHashInt(a2);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int SplitDigit(IntPtr l) {
		try {
			System.String self=(System.String)checkSelf(l);
			var ret=self.SplitDigit();
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int GetDBCCaseLength(IntPtr l) {
		try {
			System.String self=(System.String)checkSelf(l);
			var ret=self.GetDBCCaseLength();
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,Insert);
		addMember(l,ToBytes);
		addMember(l,ToHashInt);
		addMember(l,SplitDigit);
		addMember(l,GetDBCCaseLength);
